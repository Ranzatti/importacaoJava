    ...
    public static void init(int anoSonner) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                // Elem despesa
                ElemDespesa elemDespesa = new ElemDespesa(anoAtual, ficha, empresa, orgao, unidade, subUnidade, funcao, subFuncao, programa, projAtiv, categoria, grupo, modalidade, elemento, desdobramento, orcado, BigDecimal.ZERO, BigDecimal.ZERO);
