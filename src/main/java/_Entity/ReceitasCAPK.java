...
@Embeddable
public class ReceitasCAPK implements Serializable {
	...
	public ReceitasCAPK(Date ano, Integer ficha, Integer versaoRecurso, Integer fonteRecurso, Integer caFixo, Integer caVariavel) {
		this.ano = ano;
		this.ficha = ficha;
