...
@Embeddable
public class ElemAnuladosPK implements Serializable {
    ...
    public ElemAnuladosPK() {
    }

    public ElemAnuladosPK(Date ano, Integer codigo, Integer ficha, Integer versaoRecurso, Integer fonteRecurso, Integer caFixo, Integer caVariavel) {
        this.ano = ano;
        this.codigo = codigo;
        this.ficha = ficha;
