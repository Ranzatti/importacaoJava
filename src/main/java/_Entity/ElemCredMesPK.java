...
@Embeddable
public class ElemCredMesPK implements Serializable {
    ...
    public ElemCredMesPK() {
    }

    public ElemCredMesPK(Date ano, Integer codigo, Integer ficha, Integer versaoRecurso, Integer fonteRecurso, Integer caFixo, Integer caVariavel, Integer mes) {
        this.ano = ano;
        this.codigo = codigo;
        this.ficha = ficha;
