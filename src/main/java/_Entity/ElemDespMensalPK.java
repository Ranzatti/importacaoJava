...
@Embeddable
public class ElemDespMensalPK implements Serializable {
	...
	public ElemDespMensalPK() {
	}

	public ElemDespMensalPK(Date ano, Integer ficha, Integer versaoRecurso, Integer fonteRecurso, Integer caFixo, Integer caVariavel, Integer mes) {
		this.ano = ano;
		this.ficha = ficha;
